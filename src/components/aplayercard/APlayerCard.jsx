...
const APlayerCard = ({availablePlayer}) => {
  // console.log (availablePlayer);

  return (
      <div className="bg-base-100 shadow-sm card">
        <figure>
          <img className="size-fit object-cover"
        ...
        <div className="card-body">
          <div className="flex items-center gap-4">
            <img
              ...
              alt={availablePlayer.PlayerName}
            />
            <h2 className="text-[#131313] card-title">{availablePlayer.PlayerName}</h2>
          </div>

          <div className="flex justify-between gap-4 mb-4">
            <div className="flex items-center gap-4">
              <img className="opacity-50" src={iconFlag} alt={availablePlayer.PlayerCountry} />
              <p className="text-[#131313]">{availablePlayer.PlayerCountry}</p>
            </div>
            <button className="btn btn-active">{availablePlayer.PlayerRole}</button>
          </div>
          <hr className="text-[#1313131a]" />

          <div className="flex justify-between items-center gap-4 mt-4">
            <h4 className="font-bold">Rating</h4>
            <h4 className="font-bold">{availablePlayer.Impact} {availablePlayer.SuccessRating}</h4>
          </div>
